...
//	public PicUploadStatus imgUpload(@ModelAttribute("file") ProductImage productImage,@PathVariable String email) {
//
//		String uploadedPicName = productImage.getImgUploader().getOriginalFilename();
//		String fileName = productImage.getImgUploader() + "-" + uploadedPicName;
//
//		try {
//			FileCopyUtils.copy(productImage.getImgUploader().getInputStream(),
//					new FileOutputStream("C:\\Users\\Admin\\Desktop\\imagebackend\\" + fileName));
//			//new FileOutputStream("G:\\Final Project\\uploads\\" + fileName));
//		} catch (IOException e) {
//			
//				System.out.println(e.getMessage());
//		}
//
//		//Product product = hostService.findCarById(carPicture.getCarId());
//		Product product = new Product();
//		product.setImageName(fileName);
//		product.setCategories(productImage.getProduct().getCategories());
//		product.setPrice(productImage.getProduct().getPrice());
//		product.setProductName(productImage.getProduct().getProductName());
//		product.setStocks(productImage.getProduct().getStocks());
//		iProductService.addProduct(product, email);
//		return new PicUploadStatus("Car Pic Uploaded");
//	}
